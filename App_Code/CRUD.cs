...
//        public static string conStr = WebConfigurationManager.ConnectionStrings["taskProjectEntities"].ConnectionString;
//        // I create a con object once and then use it in methods
//        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["taskProjectEntities"].ConnectionString);
//        taskProjectEntities db = new taskProjectEntities();  // This uses the EF connection string automatically
...
// REFACTORED CRUD CLASS WITHOUT SHARED 'con' VARIABLE
...
//        public static string conStr = WebConfigurationManager.ConnectionStrings["taskProjectEntities_SQL"].ConnectionString;
...
//            using (var cmd = new SqlCommand(mySql, con))
...
//        public DataTable getDTViaSpWithPara(string storedProcedure, Dictionary<string, object> spInputPara)
//        {
//            using (var con = GetConnection())
...
namespace TasksTrackerWebApp
{
    ...
    public class CRUD
    {
        ...
        // istesd of pasting connection string in each page this refrence the connection on the webconfig  
        // I create connection string once, then use it in creating a new connection in each method and use the static string "conStr"
        public static string conStr = WebConfigurationManager.ConnectionStrings["TaskTrackerDB"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["TaskTrackerDB"].ConnectionString);
        public CRUD()
        {
            //
            // TODO: Add constructor logic here
